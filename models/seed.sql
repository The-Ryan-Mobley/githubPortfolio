...
("Today I Scraped","assets/images/TIS.png","https://fast-taiga-02345.herokuapp.com/","https://github.com/The-Ryan-Mobley/newsScrape","Full-Stack using node express, axios/ cherrio for scraping, mongoDB with the mongoose object modeling tool, and skeleton css","Stuck in an awkward elevator ride and need some slightly interesting facts to make small talk? This website is just for you! this site scrapes to trending section of reddit's 'todayilearned' or TIL subreddit. Avoid all the wierd ads disguised as post, and the pop ups about their app. The site does offer links to both the reddit thread, and the posted link; you can also leave comments by clicking the associated button."),
("Click-React-App","assets/images/CRA.png","https://the-ryan-mobley.github.io/click-react-app/","Serverless using only React and Skeleton css","https://github.com/The-Ryan-Mobley/click-react-app","This website uses react to create a memory style game. The page will display a series of images. When the user clicks an image the images will shuffle. If the user clicks a new image the score will increase, if they pick one of the six previous images they've cli- cked the score will decrase. The goal is to get as high of a score as possible.");
